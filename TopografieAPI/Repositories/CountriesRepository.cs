...
namespace TopografieAPI.Repositories
{
    ...
    public class CountriesDbInitializer : DropCreateDatabaseIfModelChanges<CountriesRepository>
    {
        protected override void Seed(CountriesRepository context)
        {
            ...
            context.Countries.Add(new CountryEntity { CountryId = 53, Name = "Canada", Name_nl = "Canada", Region = "019", SubRegion = "021", Code = "CA" });
            context.Countries.Add(new CountryEntity { CountryId = 54, Name = "Greenland", Name_nl = "Groenland", Region = "019", SubRegion = "021", Code = "GL" });
            context.Countries.Add(new CountryEntity { CountryId = 55, Name = "United States", Name_nl = "Verenigde Staten", Region = "019", SubRegion = "021", Code = "US" });
            context.Countries.Add(new CountryEntity { CountryId = 56, Name = "Mexico", Name_nl = "Mexico", Region = "019", SubRegion = "013", Code = "MX" });
            context.Countries.Add(new CountryEntity { CountryId = 57, Name = "Belize", Name_nl = "Belize", Region = "019", SubRegion = "013", Code = "BZ" });
            context.Countries.Add(new CountryEntity { CountryId = 58, Name = "Guatemala", Name_nl = "Guatemala", Region = "019", SubRegion = "013", Code = "GT" });
            context.Countries.Add(new CountryEntity { CountryId = 59, Name = "El Salvador", Name_nl = "El Salvador", Region = "019", SubRegion = "013", Code = "SV" });
            context.Countries.Add(new CountryEntity { CountryId = 60, Name = "Costa Rica", Name_nl = "Costa Rica", Region = "019", SubRegion = "013", Code = "CR" });
            context.Countries.Add(new CountryEntity { CountryId = 61, Name = "Honduras", Name_nl = "Honduras", Region = "019", SubRegion = "013", Code = "HN" });
            context.Countries.Add(new CountryEntity { CountryId = 62, Name = "Nicaragua", Name_nl = "Nicaragua", Region = "019", SubRegion = "013", Code = "NI" });
            context.Countries.Add(new CountryEntity { CountryId = 63, Name = "Panama", Name_nl = "Panama", Region = "019", SubRegion = "013", Code = "PA" });
            context.Countries.Add(new CountryEntity { CountryId = 64, Name = "Cuba", Name_nl = "Cuba", Region = "019", SubRegion = "029", Code = "CU" });
            context.Countries.Add(new CountryEntity { CountryId = 65, Name = "Jamaica", Name_nl = "Jamaica", Region = "019", SubRegion = "029", Code = "JM" });
            context.Countries.Add(new CountryEntity { CountryId = 66, Name = "Bahamas", Name_nl = "Bahama's", Region = "019", SubRegion = "029", Code = "BS" });
            context.Countries.Add(new CountryEntity { CountryId = 67, Name = "Haiti", Name_nl = "Haïti", Region = "019", SubRegion = "029", Code = "HT" });
            context.Countries.Add(new CountryEntity { CountryId = 68, Name = "Dominican Republic", Name_nl = "Dominicaanse Republiek", Region = "019", SubRegion = "029", Code = "DO" });
            context.Countries.Add(new CountryEntity { CountryId = 69, Name = "Puerto Rico", Name_nl = "Puerto Rico", Region = "019", SubRegion = "029", Code = "PR" });
            context.Countries.Add(new CountryEntity { CountryId = 70, Name = "Virgin Islands", Name_nl = "Maagdeneilanden", Region = "019", SubRegion = "029", Code = "VI" });
            context.Countries.Add(new CountryEntity { CountryId = 71, Name = "Saint Martin", Name_nl = "Sint Maarten", Region = "019", SubRegion = "029", Code = "SX" });
            context.Countries.Add(new CountryEntity { CountryId = 72, Name = "Anguilla", Name_nl = "Anguilla", Region = "019", SubRegion = "029", Code = "AI" });
            context.Countries.Add(new CountryEntity { CountryId = 73, Name = "Bonaire", Name_nl = "Bonaire", Region = "019", SubRegion = "029", Code = "BQ" });
            context.Countries.Add(new CountryEntity { CountryId = 74, Name = "Antigua and Barbuda", Name_nl = "Antigua en Barbuda", Region = "019", SubRegion = "029", Code = "AG" });
            context.Countries.Add(new CountryEntity { CountryId = 75, Name = "Saint Kitts and Nevis", Name_nl = "Saint Kitts en Nevis", Region = "019", SubRegion = "029", Code = "KN" });                        
            context.Countries.Add(new CountryEntity { CountryId = 76, Name = "Egypt", Name_nl = "Egypte", Region = "002", SubRegion = "015", Code = "EG" });
            context.Countries.Add(new CountryEntity { CountryId = 77, Name = "Australia", Name_nl = "Australië", Region = "009", SubRegion = "053", Code = "AU" });
