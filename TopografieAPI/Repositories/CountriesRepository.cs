...
namespace TopografieAPI.Repositories
{
    ...
    public class CountriesDbInitializer : DropCreateDatabaseIfModelChanges<CountriesRepository>
    {
        protected override void Seed(CountriesRepository context)
        {
            ...
            context.Countries.Add(new CountryEntity { CountryId = 76, Name = "Egypt", Name_nl = "Egypte", Region = "002", SubRegion = "015", Code = "EG", ShowSubRegion = false, DifficultyLevel = 1 });
            context.Countries.Add(new CountryEntity { CountryId = 77, Name = "Australia", Name_nl = "Australië", Region = "009", SubRegion = "053", Code = "AU", ShowSubRegion = false, DifficultyLevel = 0 });
